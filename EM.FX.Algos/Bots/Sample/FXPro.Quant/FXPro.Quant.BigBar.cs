...
namespace EM.FX.Algo.Bots.Sample.FXPro.Quant
{
   ...
   (MarketSeries.TickVolume.LastValue == 1))) _Open_Sell_Position = _OpenPosition(0, true, Symbol.Code, TradeType.Sell, _Lots, 10, _SL_Points, _TP_Points, "");
            if ((((_Close - (_Open)) >= _Transform) &&
   (MarketSeries.TickVolume.LastValue == 1))) _Open_Buy_Position = _OpenPosition(0, true, Symbol.Code, TradeType.Buy, _Lots, 10, _SL_Points, _TP_Points, "");

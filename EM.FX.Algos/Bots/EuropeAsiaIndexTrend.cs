...
namespace EM.FX.Algos.Bots
{
    ...
    public class EuropeAsiaIndexTendBot : Robot
    {
        ...
        [Parameter("Market Order Label", DefaultValue = "EM.FX Europe and Asia Index Tend Bot v.3")]
        ...
        protected override void OnTick()
        {
            if (Account.Balance >= 7000)
            {
                ...
                var startTradingTime = new TimeSpan(9, 55, 0);
